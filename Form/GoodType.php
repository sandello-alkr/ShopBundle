...
namespace alkr\ShopBundle\Form;
...
class GoodType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('count')
            ->add('price')
            ->add('preview', new \alkr\CMSBundle\Form\PhotoPureType(),array('label'=>'Превью для родительской страницы'))
